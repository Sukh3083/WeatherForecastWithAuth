...
using WeatherForecastWithAuth.Services;

namespace WeatherForecastWithAuth.Models
{
    public class AuthenticateService : IAuthenticateService
    {
        ...
        {
            new Student{StudentId =1, Fname = "Sukhjinder", Lname="Singh", UserName="sukhjinder", Password ="singh"}
        };
